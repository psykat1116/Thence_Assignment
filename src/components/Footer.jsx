...
const Footer = () => {
  return (
    <div className="w-full rounded-xl flex md:flex-row flex-col justify-between items-center text-text_black bg-[#F5F5F5] md:p-8 p-4 mt-10 font-manrope max-md:gap-4">
      <p className="flex gap-3 items-center">
        ...
        <p>Talop {new Date().getFullYear()}. All rights reserved</p>
      </p>
      <p className="flex justify-between items-center underline sm:gap-12 gap-2 cursor-pointer sm:flex-row flex-col">
