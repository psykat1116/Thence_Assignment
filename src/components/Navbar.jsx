...
const Header = ({ isLoginPage }) => {
  ...
  return (
    <div className="w-full md:pl-10 pl-3 md:pr-3 pr-1 py-2 flex justify-between items-center text-text_black">
      ...
      <div className="font-manrope flex items-center justify-between gap-3 text-[15px]">
        {isLoginPage ? (
          <div
            className="border border-[#EAEAEA] p-3 rounded-[40px] cursor-pointer hover:bg-[#F1F1F1] ease-in duration-200 min-[1000px]:scale-100 md:scale-75 scale-[0.6]"
            onClick={() => navigate("/")}
          >
            <svg
              width="32"
